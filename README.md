...
`curl -H "Content-Type: application/json" -X POST -d '{"orig_port_coded":"","dest_port_coded":"","days_to_flight":"","depart_yr":"","depart_mo":"","depart_day":"","duration_total_min":"","stops":""}' "http://[FILL IN INSTANCE IP]:5000/predict_airfare"`  
